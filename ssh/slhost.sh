...
rm -rf /root/nsdomain
rm -rf /var/lib/hokage/ipvps.conf
rm nsdomain
rm domain
...
#
DOMAIN=orhochimaru.hokagelegend.my.id
SUB_DOMAIN=orhochimaru.hokagelegend.my.id
NS_DOMAIN=ns.hokagelegend.my.id
...
rm -rf /etc/xray/domain
rm -rf /root/nsdomain
echo "IP=""$SUB_DOMAIN" >> /var/lib/hokage/ipvps.conf
